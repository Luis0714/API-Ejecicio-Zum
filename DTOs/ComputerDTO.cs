...
namespace DTOs
{
    public class ComputerDTO
    {
        ...
        public int TypeComputer { get; set; }
            ...
            public ComputerDTO(string Brand, string Modelo, int RealeseYear, string Color, int DefaultCapacity, int MaxCapacity, string Processor, int TypeDisc, int DiscCapacity, int TypeComputer)
            {
